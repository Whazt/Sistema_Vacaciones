<nav class="bg-gray-800" x-data="{ open: false }">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="{{ route('areas.index') }}" class="{{ request()->routeIs('areas.index') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Áreas</a>
              <a href="{{route('cargos.index')}}" class="{{ request()->routeIs('cargos.index') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Cargos</a>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3" x-data="{open : false}">
              <div>
                <button x-on:click="open = !open" type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  <span class="absolute -inset-1.5"></span>
    ...
    <div x-show="open" class="md:hidden" id="mobile-menu" >
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="{{ route('areas.index') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Team</a>
