    ...
    <x-dialog-modal wire:model="open_edit" wire:click.away="cancelar">
        ...
        <x-slot name="content">
            ...
            <div class="mb-5">
                ...
                <input wire:model="dias_vacaciones_usados" type="text" id="dias_vacaciones_usados" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required />
