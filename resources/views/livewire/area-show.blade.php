                                        ...
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div class="inline-flex items-center gap-x-3">
                                                    ...
                                                    <div class="flex items-center gap-x-1">
                                                        <div>
                                                            <h2 class="font-medium text-gray-800 ">{{$area->id}}</h2>
                                            ...
                                            <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 ">
                                                    ...
                                                    <h2 class="text-sm font-normal ">{{$area->nombre}}</h2>
                                                </div>
                                            </td>
                                            <td class="px-1 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div class="inline-flex items-center px-3 py-1 rounded-full  ">
                                                    ...
                                                    <h2 class="text-sm font-normal ">{{$area->descripcion}}</h2>
                                                </div>
                                            </td>
                                           
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    <button wire:click="delete({{ $area->id }})" class="text-gray-500 transition-colors duration-200  hover:text-red-500 focus:outline-none">
